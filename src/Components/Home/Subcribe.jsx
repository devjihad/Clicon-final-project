                ...
                <div className='flex flex-col items-center'>
                    ...
                    <div className='relative'>
                        <input type="text" name="" id="" placeholder='Email address' className='outline-0 border-0 bg-white py-3 px-5 w-155 mb-5'/>
                         <button className='bg-[#FA8232] text-4 font-semibold flex items-center gap-1 px-3 py-1 text-white rounded-sm absolute top-2 right-3'>Shop Now <IoIosArrowRoundForward/> </button>
                    </div>
